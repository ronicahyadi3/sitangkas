            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen LS SPP hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.confirmations.submitPPTK', [
            'url' => route('ls.spp.submit.pptk'),
        ])

        @include('components.confirmations.submit', [
            'url' => route('ls.spp.submit'),
        ])
        @include('components.form.formCrud', [
            'urlStore' => route('ls.spp.store'),
            'urlUpdate' => route('ls.spp.update', ':id'),
            'urlEdit' => route('ls.spp.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
