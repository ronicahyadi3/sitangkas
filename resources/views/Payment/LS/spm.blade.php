            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen LS SPM hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.confirmations.submit', [
            'url' => route('ls.spm.submit'),
        ])
        @include('components.form.formCrud', [
            'urlStore' => route('ls.spm.store'),
            'urlUpdate' => route('ls.spm.update', ':id'),
            'urlEdit' => route('ls.spm.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
    @include('components.informations.Table', [
        'subtitle' => 'Pencairan Langsung',
        'title' => 'Dokumen SPM',
        'url' => route('ls.spm.json'),
        'nameTable' => 'mainTable',
        'jabatanAccessAdd' => [7],
        'columns' => [
            [
