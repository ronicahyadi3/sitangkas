            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen LS SP2D hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.confirmations.submit', [
            'url' => route('ls.sp2d.submit'),
        ])
        @include('components.form.formCrud', [
            'urlStore' => route('ls.sp2d.store'),
            'urlUpdate' => route('ls.sp2d.update', ':id'),
            'urlEdit' => route('ls.sp2d.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
