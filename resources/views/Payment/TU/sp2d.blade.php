            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen SP2D TU hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.form.formCrud', [
            'urlStore' => route('tu.sp2d.store'),
            'urlUpdate' => route('tu.sp2d.update', ':id'),
            'urlEdit' => route('tu.sp2d.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
