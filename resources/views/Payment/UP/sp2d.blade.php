            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen SP2D UP hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.form.formCrud', [
            'urlStore' => route('up.sp2d.store'),
            'urlUpdate' => route('up.sp2d.update', ':id'),
            'urlEdit' => route('up.sp2d.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
