            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen GU SKPD NPD hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.confirmations.submit', [
            'url' => route('gu-skpd.npd.submit'),
        ])

        @include('components.form.formCrud', [
            'urlStore' => route('gu-skpd.npd.store'),
            'urlUpdate' => route('gu-skpd.npd.update', ':id'),
            'urlEdit' => route('gu-skpd.npd.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
