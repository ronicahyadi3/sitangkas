            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen GU SKPD SP2D hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.form.formCrud', [
            'urlStore' => route('gu-skpd.sp2d.store'),
            'urlUpdate' => route('gu-skpd.sp2d.update', ':id'),
            'urlEdit' => route('gu-skpd.sp2d.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
    ...
    @unless ($isAuditor)
        @include('components.informations.Table', [
            'url' => route('gu-skpd.sp2d.spm.json'),
            'nameTable' => 'formTable',
            'jabatanAccessAdd' => [],
            'data' => [
                'edited' => 'Edited',
