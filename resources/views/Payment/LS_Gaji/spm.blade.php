            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen LS Gaji SPM hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
                    ...
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                ...
                                @include('components.form.inputFilePdf', [
                                    'title' => 'Dokumen Pernyataan SKPD',
                                    'field' => 'sp',
                                    'readonly' => true,
                                ])
                                @include('components.form.inputFilePdf', [
                                    'title' => 'Dokumen Pengajuan SKPD',
                                    'field' => 'sp_pengajuan',
                                    'readonly' => true,
                                ])
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.confirmations.submit', [
            'url' => route('ls-gaji.spm.submit'),
        ])
        @include('components.form.formCrud', [
            'urlStore' => route('ls-gaji.spm.store'),
            'urlUpdate' => route('ls-gaji.spm.update', ':id'),
            'urlEdit' => route('ls-gaji.spm.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
    @include('components.informations.Table', [
        ...
        'columns' => [
            ...
            ['data' => 'updated_at_spm', 'class' => 'text-center text-wrap', 'title' => 'Tanggal'],
            ['data' => 'unit_kerja_spm', 'class' => 'text-start text-wrap', 'title' => 'Unit Kerja'],
            [
                'data' => 'nomor',
    ...
    @unless ($isAuditor)
        @include('components.informations.Table', [
            'url' => route('ls-gaji.spm.spp.json'),
            'nameTable' => 'formTable',
            'jabatanAccessAdd' => [],
            'data' => [
                'edited' => 'Edited',
            ...
            'columns' => [
                ...
                ['data' => 'created_at_spp', 'class' => 'text-center text-wrap', 'title' => 'Tanggal'],
    ...
    @unless ($isAuditor)
        ...
        <script>
            ...
            function resetFormAdd() {
                $('#nomor_spm, #nomor_sptjm').val('');

                [
                    ['file_spm', 'name_spm'],
                    ['file_sptjm', 'name_sptjm'],
                    ['file_sp', 'name_sp'],
                    ['file_sp_pengajuan', 'name_sp_pengajuan']
                ].forEach(([file, label]) => {
                    $('#' + file).val('');
            ...
            function formEdit(d, id) {
                $('#nomor_spm').val(d.data.nomor_spm);
                $('#nomor_sptjm').val(d.data.nomor_sptjm);
