            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen GU Unit Kerja LPJ, SPP, BMD, dan LPJ BPP hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
                    ...
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            <div class="card-header pb-0 d-flex justify-content-between">
                                <div>
                                    <h3 class="font-weight-bolder text-info text-gradient">Unggah Dokumen LPJ</h3>
...
@section('additionals')
    ...
    @accessJabatan([9])
        @include('components.form.formCrud', [
            'urlStore' => route('gu-uk.lpj.store'),
            'urlUpdate' => route('gu-uk.lpj.update', ':id'),
            'urlEdit' => route('gu-uk.lpj.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endaccessJabatan
    ...
    @include('components.informations.Table', [
        ...
        'title' => 'Dokumen LPJ, SPP & BMD',
        'url' => route('gu-uk.lpj.json'),
        'nameTable' => 'mainTable',
        'jabatanAccessAdd' => [9],
        'columns' => [
            [
            ...
            ['data' => 'nomor_lpj_bpp', 'class' => 'text-start text-wrap', 'title' => 'Nomor LPJ BPP', 'render' => 'renderNomor'],
    ...
    @accessJabatan([9])
        @include('components.informations.Table', [
            'url' => route('gu-uk.lpj.lpj-bpp.json'),
            'nameTable' => 'formTable',
            'jabatanAccessAdd' => [],
            'data' => [
                'edited' => 'Edited',
            ...
            'columns' => [
                ...
                ['data' => 'unit_kerja', 'class' => 'text-start text-wrap', 'title' => 'Unit Kerja'],
                ['data' => 'nomor', 'class' => 'text-start text-wrap', 'title' => 'Nomor LPJ BPP', 'render' => 'renderNomor'],
                [
                    'data' => 'status',
                    'class' => 'text-center',
                    'searchable' => false,
    ...
    @accessJabatan([9])
        <script>
            function buildFormData() {
                ...
                formData.append('selected_lpj_bpp', $('input[name="selected_lpj_bpp"]:checked').val());
                ...
                ['file_spp', 'file_lpj', 'file_bmd'].forEach(id => {
            ...
            async function formEdit(res, id) {
                ...
                $('#file_spp, #file_lpj, #file_bmd').val('');
                $('#name_spp, #name_lpj').text('Kosongkan jika file tidak diganti');
                ...
                if (typeof checkBelanjaAndResetFile === 'function') {
                    checkBelanjaAndResetFile();
                }
            ...
            function StoreData() {
                if (!$('input[name="selected_lpj_bpp"]:checked').val()) {
                    notification({
                        status: 400,
                        message: 'Pilih dokumen LPJ BPP terlebih dahulu.'
                    });
                    return;
                }
