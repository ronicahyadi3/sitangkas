            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen GU Unit Kerja SPM hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.confirmations.submit', [
            'url' => route('gu-uk.spm.submit'),
        ])
        @include('components.form.formCrud', [
            'urlStore' => route('gu-uk.spm.store'),
            'urlUpdate' => route('gu-uk.spm.update', ':id'),
            'urlEdit' => route('gu-uk.spm.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
