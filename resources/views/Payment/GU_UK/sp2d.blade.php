            ...
            <div class="card-body py-3">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        ...
                        <div class="text-sm text-secondary">Dokumen GU Unit Kerja SP2D hanya dapat dilihat melalui detail dokumen dan riwayat perubahan.</div>
                    </div>
                    ...
                    <div class="card card-plain">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 input-group">
                                ...
                                <input type="number" class="form-control ps-1" id="rekening" placeholder="0">
                            </div>
...
@section('additionals')
    ...
    @unless ($isAuditor)
        ...
        @include('components.form.formCrud', [
            'urlStore' => route('gu-uk.sp2d.store'),
            'urlUpdate' => route('gu-uk.sp2d.update', ':id'),
            'urlEdit' => route('gu-uk.sp2d.edit', ':id'),
            'modalId' => 'add',
            'submitId' => 'submit',
        ])
    @endunless
    @include('components.informations.Table', [
        'subtitle' => 'GU Unit Kerja',
        'title' => 'Dokumen SP2D',
        'url' => route('gu-uk.sp2d.json'),
        'nameTable' => 'mainTable',
        'jabatanAccessAdd' => [4],
        'columns' => [
            [
            ...
            ['data' => 'nomor', 'class' => 'text-start text-wrap', 'title' => 'Nomor SP2D', 'render' => 'renderNomor'],
            ...
            ['data' => 'nominal', 'class' => 'text-start text-wrap', 'render' => 'renderRupiah', 'title' => 'Nominal'],
            ['data' => 'user_name', 'class' => 'text-start text-wrap', 'title' => 'BUD / Kuasa BUD'],
            ['data' => 'status', 'class' => 'text-center', 'searchable' => false, 'orderable' => false, 'title' => 'Status'],
            ['data' => 'action', 'class' => 'text-center', 'searchable' => false, 'orderable' => false, 'title' => 'Aksi/Opsi'],
        ],
    ])
    @unless ($isAuditor)
        @include('components.informations.Table', [
            'url' => route('gu-uk.sp2d.spm.json'),
            'nameTable' => 'formTable',
            'jabatanAccessAdd' => [],
            'data' => [
                'edited' => 'Edited',
            ...
            'columns' => [
                ...
                ['data' => 'unit_kerja', 'class' => 'text-start text-wrap', 'title' => 'Unit Kerja'],
                ['data' => 'nomor', 'class' => 'text-start text-wrap', 'title' => 'Nomor SPM', 'render' => 'renderNomor'],
                ['data' => 'status', 'class' => 'text-center', 'searchable' => false, 'orderable' => false, 'title' => 'Dokumen'],
                ['data' => 'action', 'class' => 'text-center', 'searchable' => false, 'orderable' => false, 'title' => 'Aksi/Opsi'],
            ],
        ])
    ...
    @accessJabatan([4])
        <script>
            ...
            function buildFormData() {
                ...
                formData.append('nominal', Number(AutoNumeric.getNumber('#nominal')).toFixed(2));
            ...
            function resetFormAdd() {
                ...
                nominal.set(0);
                $('#file_sp2d').val('');
                $('#name_sp2d').text('Belum ada file yang dipilih');
            }
            ...
            function formEdit(d, id) {
                ...
                $('#users').val(d.data.users_to).trigger('change');
