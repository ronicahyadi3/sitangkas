...
class LS_GAJI
{
    ...
    public static function withSpm($query, bool $join = true)
    {
        ...
        return $query
            ...
            ->where('document.payment_type', 'LS_GAJI')
