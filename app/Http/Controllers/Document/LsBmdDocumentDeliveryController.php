...
final class LsBmdDocumentDeliveryController extends Controller
{
    public function content(
        ...
        $artifact = $artifactResolver->resolve($this->resolveLsBmd($document));
    ...
    private function resolveLsBmd(string $encryptedDocumentId): Document
    {
        try {
